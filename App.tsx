    ...
    <div className="bg-gray-100 text-ink font-body antialiased selection:bg-accent selection:text-ink min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer" onClick={() => window.scrollTo(0,0)}>
            <div className="w-10 h-10 flex items-center justify-center">
              <Stickman type="signaling" className="w-full h-full scale-125 translate-y-2" />
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <ComicButton variant="ink" size="sm" className="border-2 border-white shadow-[4px_4px_0px_0px_#30e8c9]">
              GET CV
            </ComicButton>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="border-4 border-ink bg-white relative overflow-hidden irregular-border p-8 lg:p-16 halftone-bg flex flex-col lg:flex-row items-center gap-12 comic-shadow">
          <div className="flex-1 space-y-8 order-2 lg:order-1">
            ...
            <h2 className="text-6xl lg:text-8xl font-comic leading-none">
              HI, I’M <span className="text-white drop-shadow-[4px_4px_0px_rgba(0,0,0,1)] bg-accent px-4 py-1 border-[3px] border-ink inline-block transform rotate-1">ALPER</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <a href="/assets/Alper-Salik-Resume.pdf" download className="inline-block">
                <ComicButton variant="accent" size="lg">DOWNLOAD CV</ComicButton>
              </a>
              <div className="flex gap-4">
                <a href="#" className="w-14 h-14 bg-white border-4 border-ink flex items-center justify-center comic-shadow-sm hover:translate-y-1 hover:shadow-none transition-all">
                ...
                <a href="#" className="w-14 h-14 bg-primary border-4 border-ink flex items-center justify-center comic-shadow-sm hover:translate-y-1 hover:shadow-none transition-all">
          ...
          <div className="flex-1 flex flex-col items-center order-1 lg:order-2 w-full">
            ...
            <img src="/assets/hero/heroImage.png" alt="Hero" className="w-full max-w-[420px] h-auto drop-shadow-2xl" />
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Bio Section */}
          <section id="about" className="border-4 border-ink bg-white relative overflow-hidden irregular-border p-8 halftone-bg comic-shadow rotate-[0.5deg]">
            <div className="absolute top-0 right-0 bg-ink text-white font-comic px-4 py-1 rotate-6 z-10">PAGE 02</div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="w-full md:w-1/3 flex flex-col items-center">
                ...
                <Stickman type="thinking" className="w-full max-w-[180px] h-auto" />
              </div>
            </div>
          </section>

          {/* Chronicles Section */}
          <section id="experience" className="border-4 border-ink bg-white relative overflow-hidden irregular-border p-8 halftone-bg comic-shadow -rotate-[0.5deg]">
            <h2 className="text-5xl font-comic mb-10 underline decoration-primary decoration-8 underline-offset-8">CHRONICLES</h2>
              ...
              {EXPERIENCES.map((exp, idx) => (
                <div key={idx} className="relative pl-14 group">
                  ...
                  <div className="bg-white border-[3px] border-ink p-5 comic-shadow-sm group-hover:bg-gray-50 transition-colors">
                    ...
                    <p className="font-marker text-sm mt-1" style={{ color: exp.color }}>{exp.period}</p>
                    <p className="font-hand font-bold text-lg mt-3">{exp.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="projects" className="py-12">
          <h2 className="text-7xl lg:text-8xl font-comic text-center mb-16 drop-shadow-lg transform -rotate-1">TOP MISSIONS</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {PROJECTS.map((project, idx) => (
              <div key={project.id} className="border-4 border-ink bg-white overflow-hidden comic-shadow group hover:-translate-y-2 transition-transform">
                <div 
                ...
                >
                  ...
                  {project.iconType === 'mobile' ? (
                    <svg className="w-56 h-56 transition-transform group-hover:scale-110" viewBox="0 0 200 200" fill="none">
                      <rect x="70" y="30" width="60" height="120" rx="8" stroke="black" strokeWidth="4" fill="white" />
                      <rect x="85" y="60" width="30" height="30" stroke="black" strokeWidth="4" />
                      <path d="M85 60h10v10h-10z" fill="black" />
                      <path d="M105 80h10v10h-10z" fill="black" />
                      <path d="M85 80h10v10h-10z" fill={project.color} />
                      <circle cx="100" cy="140" r="4" stroke="black" strokeWidth="4" />
                    </svg>
                  ) : (
                    <svg className="w-56 h-56 transition-transform group-hover:scale-110" viewBox="0 0 200 200" fill="none">
                      <circle cx="60" cy="140" r="15" stroke="black" strokeWidth="4" />
                      <circle cx="140" cy="140" r="15" stroke="black" strokeWidth="4" />
                      <path d="M60 140 L90 100 H130 L140 140" stroke="black" strokeWidth="4" />
                      <path d="M90 100 L80 60 H50" stroke="black" strokeWidth="4" />
                      <rect x="110" y="80" width="30" height="20" fill={project.color} stroke="black" strokeWidth="3" />
        ...
        {/* Contact Section */}
        <section id="contact" className="border-4 border-ink bg-white relative overflow-hidden irregular-border p-12 halftone-bg text-center space-y-12 comic-shadow">
          <div className="flex flex-col items-center">
            <SpeechBubble className="mb-8 transform rotate-2 px-12 text-2xl">
              HEY THERE! LET'S CONNECT!
            </SpeechBubble>
            <Stickman type="signaling" className="w-full max-w-[200px] h-auto" />
          </div>
          
          <h2 className="text-6xl lg:text-8xl font-comic transform -rotate-1 tracking-wider">THE SIGNAL IS UP!</h2>
